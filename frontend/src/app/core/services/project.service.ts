...
export class ProjectService {
  ...
  public getProjectsByUser(userId: number): Observable<HttpResponse<ProjectInfo[]>> {
  ...
  public startProjectBuild(projectId: number): Observable<any> {
    return this.httpService.postRequest<any>(`${this.routePrefix}/${projectId}/build`, null);
  }
}
